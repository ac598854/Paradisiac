...
<% 
  	PromotionVO promotionVO = (PromotionVO) request.getAttribute("proVO");
%>
                ...
                <%@ include file="/back-end/index/back-left_product.jsp" %>
                    ...
                    <body bgcolor='white'>
                                            ...
                                            <FORM METHOD="post"  ACTION="<%=request.getContextPath() %>/PromotionListServlet" name="form1" id="mainForm">
                                                <table>
                                                    <tr>
                                                        ...
                                                        <td><input type="TEXT" class="form-control mb-3" name="proname" id="proname" value="<%=promotionVO.getProname()%>" size="30"/></td>
                                                    </tr>
                                                    <tr>
                                                        <td class="text-start"><label for="proname" class="form-label">促銷專案描述:</label></td>
                                                        <td><input type="TEXT" class="form-control mb-3" name="prodes" id="prodes" value="<%=promotionVO.getProdes()%>"  size="30"/></td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><input type="TEXT" class="form-control mb-3"  id="discountInput" name="discount"  id="discount"  value="<%=promotionVO.getDiscount()%>" size="30"/></td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <select name="status" class="form-select mb-3" style="height: 35px; font-size: medium;" aria-label=".form-select-lg example">
                                                                <option value="true" ${(1==promotionVO.status)? 'selected' :'' }>上架</option>
                                                                <option value="false" ${(0==promotionVO.status)? 'selected' :'' }>下架</option>
                                                            </select>
                                                        </td>
                                                    </tr>
                                                </table>
                        ...
                        <% java.sql.Date startdate=null; 
                        		try { 
                        			startdate=promotionVO.getStartdate(); 
                        			} 
                        			catch (Exception e) {
			                ...
			                java.sql.Date enddate=null; 
                        		try {
                            		enddate=promotionVO.getEnddate(); 
                            		} 
                        		catch (Exception e) { 
