...
<FORM METHOD="post" ACTION="<%=request.getContextPath() %>/back-end/promotion/promotion" name="form1">
<table>
	...
	<tr>
		<td>促銷專案名稱:</td>
		<td><input type="TEXT" name="proname"  value="<%= (proVO==null)? "夏季特惠" : proVO.getProname()%>"  size="30"/></td>
	</tr>
	<tr>
		<td>促銷專案描述:</td>
		<td><input type="TEXT" name="prodes"   value="<%= (proVO==null)? "熱銷商品優惠" : proVO.getProdes()%>"  size="30"/></td>
	</tr>
	<tr>
		<td>促銷專案開始日期:</td>
	...
	<tr>
		<td>促銷專案折扣:</td>
		<td><input type="TEXT" name="discount"  value="<%= (proVO==null)? "0.80" : proVO.getDiscount()%>"  size="30"/></td>
	</tr>
	<tr>
		<td>促銷專案狀態:</td>
		<td>
