...
<body>
    ...
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/js/bootstrap.min.js">
         document.getElementById('delpho').addEventListener('click', function() {
            var selectedPhotos = [];
            ...
            // 现在，selectedPhotos 数组包含了选中的照片的值

            // 在这里，你可以继续执行其他操作，如将 selectedPhotos 发送到服务器或执行其他逻辑

            console.log(selectedPhotos); // 输出选中的照片 ID
        });
        
        /*
        checkboxes.forEach(function(checkbox) {
            selectedPhotos.push(checkbox.value);//[value1value2value3]
            console.log(selectedPhotos);
        });
        
        // 创建一个隐藏的 input 元素，用于发送选中的照片 ID
        var hiddenInput = document.createElement('input');
        hiddenInput.type = 'hidden';
        hiddenInput.name = 'selectedPhotos';
        hiddenInput.value = selectedPhotos.join(',');
        
        // 将隐藏的 input 元素添加到 form 表单中
