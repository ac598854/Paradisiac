	...
	<table id="table-1">
		<tr>
			<td>
				...
				<h4>
					<a href="select_page_product.jsp"><img src="images/back1.gif"
		...
		<table>
			...
			<tr>
				...
				<td><input type="TEXT" name="productprice"
					value="<%=productVO.getProductprice()%>" size="45" /></td>
			</tr>
			<tr>
				<td>商品庫存:</td>
				<td><input type="TEXT" name="productquantity"
					value="<%=productVO.getProductquantity()%>" size="45" /></td>
			</tr>
			<tr>
				<td>商品狀態:</td>
			...
			<tr>
				...
				<td><input type="TEXT" name="producttotalreviewcount"
					value="<%=productVO.getProducttotalreviewcount()%>" size="45" /></td>
			</tr>
			<tr>
				<td>商品評價人數:</td>
				<td><input type="TEXT" name="producttotalreviewstatus"
					value="<%=productVO.getProducttotalreviewstatus()%>" size="45" /></td>
			</tr>
			<tr>
				<td>商品類別編號:</td>
				<td><input type="TEXT" name="productcategoryno"
					value="<%=productVO.getProductcategoryno()%>" size="45" /></td>
			</tr>
