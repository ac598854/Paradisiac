	...
	<div class="container">
		<div class="row m-5 no-gutters shadow-lg">
			<div class="col-md-6 d-none d-md-block">
				<img
					src="https://images.unsplash.com/photo-1615039666131-964929ad0f1e?q=80&w=1887&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
					class="img-fluid" />
			</div>

			<div class="col-md-6 bg-white p-5">
				<h3 class="pb-3">忘記密碼</h3>
				<div class="form-style">
					<form method="post" action="ResetPass.do" name="form1"
						...
						<div class="pb-2">
							...
							<input type="hidden" name="action" value="sendRestPass">
						</div>
					</form>
					...
					<div class="pt-4 text-center">
						重新登入? <a
							href="<%=request.getContextPath()%>/front-end/members/Login.jsp">登入</a>
					</div>
				</div>
