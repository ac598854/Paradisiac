	...
	<div class="container mt-3">
		<form>
			<div class="row jumbotron box8">
				...
				<div class="col-sm-6 form-group">
					<label for="name-l">註冊驗證碼</label> <input type="text"
						class="form-control" name="lname" id="name-l"
						placeholder="Enter your last name." required>
				</div>
				<div class="col-sm-6 form-group">
					<label for="pass">帳號</label> <input type="Password"
						name="password" class="form-control" id="pass"
						placeholder="Enter your password." required>
				</div>			
				<div class="col-sm-6 form-group">
					<label for="pass">密碼</label> <input type="Password"
						name="password" class="form-control" id="pass"
						placeholder="Enter your password." required>
				</div>
					<div class="col-sm-6 form-group">
					<label for="email">會員姓名</label> <input type="email"
						class="form-control" name="email" id="email"
						placeholder="Enter your email." required>
				</div>
				<div class="col-sm-6 form-group">
					<label for="sex">性別</label> <select id="sex"
					...
					<div class="col-sm-6 form-group">
					<label for="pass">身分證字號</label> <input type="Password"
						name="password" class="form-control" id="pass"
						placeholder="Enter your password." required>
				</div>
					<div class="col-sm-6 form-group">
					<label for="Date">生日</label> <input type="Date"
				...
				<div class="col-sm-2 form-group">
					<label for="cod">Country code</label> <select
						...
						<option data-countryCode="CY" value="90">Cyprus - North
							(+90)</option>
						...
						<option data-countryCode="VG" value="1">Virgin Islands -
							British (+1)</option>
						<option data-countryCode="VI" value="1">Virgin Islands -
							US (+1)</option>
