...
<!--       </aside> -->
  ...
  <main class="main-content">
      <div class="image-container">
          <div class="image-container">
              <img src="/Paradisiac/images/02montain.jpg" alt="Interior" class="fixed-image">
            </div>
      </div>

      <div class="room-info">
         <h2>山景套房資訊</h2>
       <p class="price">價格：NT$6,500+10%</p>
      <p>床型：雙人床 160cm*200cm</p>
      <p>特色：窗外是壯闊的山脈景色，房間配備了大型落地窗，讓您能夠在舒適的室內環境中欣賞自然美景。這些套房提供了豪華的休息區，包括一個舒適的沙發和一個小書桌，適合閱讀或工作。浴室內配有現代化的設施和淋浴間，確保您能享受到舒適的沐浴體驗。</p>
      <p>房內設施：房間內提供高速無線網絡連接、衛星電視和迷你吧。房間內的裝飾簡約而現代，以軟木和自然木材為主，創造出一種溫馨而放鬆的氛圍。</p>
