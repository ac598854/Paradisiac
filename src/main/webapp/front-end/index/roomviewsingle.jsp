...
<!--       </aside> -->
  ...
  <main class="main-content">
      <div class="image-container">
          <div class="image-container">
              <img src="/Paradisiac/front-end/roomtype/image/00101.jpg" alt="Interior" class="fixed-image">
            </div>
      </div>

      <div class="room-info">
        <h2>精緻客房資訊</h2>
        <p class="price">價格：NT$5,900+10%</p>
        <p>床型：單人床 105cm*200cm 或 一大床 180cm*200cm</p>
        <p>特色：享受優質睡眠、適合親子、中央空調、免費無線上網服務、冰箱、吹風機、電熱水壺、電子保險箱、</p>
        <p>衛浴設備、乾濕分離衛浴、直撥國內外電話、110V. 220V插座、行動裝置USB充電插座等等...</p>
