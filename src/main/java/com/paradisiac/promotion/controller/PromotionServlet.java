	...
	public void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		if ("getOne_For_Display".equals(action)) {
			...
			if (!errorMsgs.isEmpty()) {
				RequestDispatcher failureView = req.getRequestDispatcher("/back-end/promotion/select.jsp");
		...
		if ("update".equals(action)) {
			...
			if (!errorMsgs.isEmpty()) {
				req.setAttribute("proVO", proVO);
				RequestDispatcher failureView = req.getRequestDispatcher("/back-end/promotion/update.jsp");
				failureView.forward(req, res);
				return;
			}
		...
		if ("insert".equals(action) && session.getAttribute("formSubmitted") == null) {
			...
			if (!errorMsgs.isEmpty()) {
				req.setAttribute("proVO", proVO);
				RequestDispatcher failureView = req.getRequestDispatcher("/back-end/promotion/add.jsp");
				failureView.forward(req, res);
				return;
			}else {
